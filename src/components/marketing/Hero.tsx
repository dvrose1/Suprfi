    ...
    <section className="pt-32 pb-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-teal/10 text-sm mb-6 text-teal">
            ...
            {/* Headline */}
            <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-6 font-display text-navy">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Link 
                href="/apply"
                className="px-8 py-4 rounded-xl text-white font-semibold text-lg transition-all hover:scale-105 flex items-center justify-center gap-2 shadow-lg bg-gradient-primary"
              >
                Check Your Rate
              ...
              <Link 
                href="/how-it-works"
                className="px-8 py-4 rounded-xl font-semibold text-lg border-2 border-navy text-navy transition-all hover:bg-gray-50"
              >
                See How It Works
              </Link>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
            <h3 className="text-lg font-semibold mb-6 text-navy font-display">See your estimated payment</h3>
            
            <div className="mb-6">
              <label className="text-sm text-gray-600 mb-2 block">How much do you need?</label>
              <div className="text-4xl font-bold mb-4 text-navy font-mono">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              {[24, 36, 48].map(term => (
                <div 
                  key={term} 
                  className="text-center p-4 rounded-xl bg-gray-50 hover:bg-teal/10 transition-colors cursor-pointer"
                >
            ...
            <Link
              href="/apply"
              className="block w-full py-4 rounded-xl text-white font-semibold text-center transition-all hover:opacity-90 bg-gradient-accent"
            >
